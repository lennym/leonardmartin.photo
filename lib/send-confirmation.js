...
export default async function (to, orderId) {
  const msg = {
    ...
    Your photos are available to download now from https://www.leonardmartin.photo/orders/${orderId}`,
    html: `
    <p>Thank you for your order from leonardmartin.photo.</p>
    <p>Your photos are available to <a href="https://www.leonardmartin.photo/orders/${orderId}">download now</a></p>
    `,
  };
  try {
